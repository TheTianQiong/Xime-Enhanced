...
object ShuangpinSchemes {
    ...
    val ZIRANMA = ShuangpinScheme(
        ...
        yunmu = mapOf(
            "a" to listOf("a"), "b" to listOf("iao"), "c" to listOf("ua"), "d" to listOf("ie"),
            ...
            "m" to listOf("un"), "n" to listOf("ue", "ui", "ve"), "o" to listOf("uo"), "p" to listOf("ai"),
            "q" to listOf("ao"), "r" to listOf("an"), "s" to listOf("ang"), "t" to listOf("eng"),
            "u" to listOf("u"), "v" to listOf("ui"), "w" to listOf("en"), "x" to listOf("ia", "ua"),
    ...
    val ABC = ShuangpinScheme(
        ...
        yunmu = mapOf(
            ...
            "u" to listOf("u"), "v" to listOf("ui"), "w" to listOf("ian"), "x" to listOf("ie"),
    ...
    val JIAJIA = ShuangpinScheme(
        ...
        yunmu = mapOf(
            ...
            "u" to listOf("u"), "v" to listOf("ui"), "w" to listOf("ei"), "x" to listOf("ue", "ve", "uai"),
